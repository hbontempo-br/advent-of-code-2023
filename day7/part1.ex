...
defmodule Hand do
  ...
  defp card_score("2"), do: 0
  defp card_score("3"), do: 1
  defp card_score("4"), do: 2
  defp card_score("5"), do: 3
  defp card_score("6"), do: 4
  defp card_score("7"), do: 5
  defp card_score("8"), do: 6
  defp card_score("9"), do: 7
  defp card_score("T"), do: 8
  defp card_score("J"), do: 9
