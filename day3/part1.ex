defmodule Day3 do
  def process(file_path) do
    ...
    part_numbers = part_number_list(numbers, symbols)
  ...
  defp part_number_list(numbers, symbols) do
    Enum.filter(
      numbers,
      fn {_, _, _, border} ->
        Enum.any?(
          border,
          fn position -> MapSet.member?(symbols, position) end
        )
      end
    )
  end
