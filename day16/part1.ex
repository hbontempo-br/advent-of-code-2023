...
defmodule Day16 do
  def process(file_path) do
    ...
    { _, traverssed_set } = transverse([{ {0, 0}, :right }], map, allowed_set, MapSet.new())

    MapSet.size(traverssed_set)
  end
    ...
    |> Enum.reduce(
      ...
      fn curr_action, { acc_allowed_set, acc_traverssed_set } ->
        case MapSet.member?(acc_allowed_set, curr_action) do
          false -> { acc_allowed_set, acc_traverssed_set }
          true ->
